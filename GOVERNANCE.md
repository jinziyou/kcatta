...
当前 Project Leadership 由 **kcatta 项目维护者**（`jinziyou` GitHub 组织下的核心维护团队）担任。Maintainers 名单见仓库根目录 [`CODEOWNERS`](.github/CODEOWNERS)（若尚未配置，则以 Project Leadership 为准）。

**原则：** 日常技术讨论鼓励共识；无法达成共识时，由 Project Leadership 做最终决定。
