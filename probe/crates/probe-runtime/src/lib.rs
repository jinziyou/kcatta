//! probe-runtime: orchestrates domain collectors into an [`AssetReport`].
//!
//! Domain logic lives in separate workspace members (`probe-asset`,
//! `probe-malware`, …). This crate only defines the [`Collector`] trait,
//! [`ScanContext`], and [`run_scan_at`].
//!
//! # Example
//!
//! ```no_run
//! use probe_asset::default_collectors;
//! use probe_runtime::run_scan_at;
//!
