//! probe-intel-sync: download remote IOC feeds to local JSON.
//!
...
use clap::Parser;
use probe_flow::intel::sync::{self, feodo};
use probe_flow::ThreatFeed;

#[derive(Debug, Parser)]
#[command(
    name = "probe-intel-sync",
    version,
    about = "Download threat-intel IOC feeds into local JSON for probe-flow-cli --intel"
)]
struct Args {
