...
import type { ScanCapability, ScanJobState, Severity } from "./contracts";
...
export const SEVERITY_META: Record<Severity, SeverityMeta> = {
  critical: { label: "严重", badge: "bg-red-600 text-white border-transparent", dot: "bg-red-600" },
  high: { label: "高危", badge: "bg-orange-500 text-white border-transparent", dot: "bg-orange-500" },
  medium: { label: "中危", badge: "bg-amber-400 text-black border-transparent", dot: "bg-amber-400" },
  low: { label: "低危", badge: "bg-slate-300 text-black border-transparent", dot: "bg-slate-400" },
  info: { label: "提示", badge: "bg-slate-200 text-black border-transparent", dot: "bg-slate-300" },
};
