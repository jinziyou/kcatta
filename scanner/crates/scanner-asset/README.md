...
```rust
use scanner_asset::{default_collectors, run_static_scan, ScanOptions, ScanTarget};

// Collector 计划（供 scanner-runtime）
...
详细参数见 [`../../README.md`](../../README.md#静态资产扫描scanner-asset)。
