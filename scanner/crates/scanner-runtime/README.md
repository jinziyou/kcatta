...
```rust
use scanner_runtime::{Collector, ScanContext, run_scan_at};

let collectors: Vec<Box<dyn Collector>> = /* from scanner-asset, scanner-malware, ... */;
