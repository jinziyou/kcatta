...
//! against [`posture_host::malware`]'s signature set (the same engine the host
...
use posture_host::malware::{scan_bytes, SignatureSet, DEFAULT_MAX_FILE_SIZE};
