//! posture-guard: real-time protection daemon (standalone binary).
//!
//! Thin wrapper over [`posture_guard::cli`] — the same CLI the umbrella `agent guard`
...
use clap::Parser;
use posture_guard::cli::GuardArgs;
