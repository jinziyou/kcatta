...
use crate::malware::{is_media_file, should_skip_entry, PSEUDO_FS, SKIP_DIR_NAMES};
...
/// Collect all secret-leak findings under `ctx.scan_root`, host-attributed to `host_id`.
