//! fusion-runtime: orchestrates domain collectors into an [`AssetReport`].
//!
//! Domain logic lives in separate workspace members (`fusion-asset`,
//! `fusion-malware`, …). This crate only defines the [`Collector`] trait,
//! [`ScanContext`], and [`run_scan_at`].
//!
//! # Example
//!
//! ```no_run
//! use fusion_asset::default_collectors;
//! use fusion_runtime::run_scan_at;
//!
