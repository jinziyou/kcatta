//! Pluggable collector interface used by domain crates (`fusion-asset`,
//! `fusion-malware`, ...).

use std::path::{Path, PathBuf};

use fusion_contract::{Asset, HostInfo, Vulnerability};
...
impl WindowsPackageProfile {
    ...
    /// Value for `fusion-asset --windows-packages`.
...
/// Domain collectors implement this trait; `fusion-host-cli` (or tests) assemble
