...
//! behind the `malware` feature, [`crate::malware`]). `fusion-runtime` (the
//! `fusion` orchestration binary) builds a plan and calls [`run_scan_at`].
//!
//! # Example
//!
//! ```no_run
//! use fusion_host::{default_collectors, run_scan_at};
//!
...
use chrono::Utc;
use fusion_contract::AssetReport;
use uuid::Uuid;
