...
//!
//! Ships a static [`fusion-asset`](fusion_asset) binary to a target over SSH,
...
//! 4. [`report::finalize_asset_report`] — merge pulled JSON into [`fusion_contract::AssetReport`]
//!
//! # Example
//!
//! ```no_run
...
//! use fusion_remote::{run_agent_scan, ssh::SshOptions, AgentScanOptions};
//!
//! let report = run_agent_scan(AgentScanOptions {
//!     ssh: SshOptions::new("root@10.0.0.1"),
//!     password: None,
//!     asset_binary: PathBuf::from("target/x86_64-unknown-linux-musl/release/fusion-asset"),
//!     scan_root: "/".into(),
//!     target: ScanTarget::Host,
//!     output_dir: PathBuf::from("./reports/host"),
//!     task_id: None,
//!     malware: None,
//!     windows_packages: fusion_runtime::WindowsPackageProfile::default(),
//! })?;
