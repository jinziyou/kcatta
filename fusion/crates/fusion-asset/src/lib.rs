...
//! and produces either per-category JSON files or [`fusion_contract::Asset`] batches via
//! the [`Collector`] trait.
//!
//! # Outputs
//!
...
//! | Runtime plan | [`default_collectors`] + [`fusion_runtime::run_scan_at`] | merged [`fusion_contract::AssetReport`] |
//!
//! # Collectors
//!
...
use fusion_runtime::Collector;

/// Default v0 collector plan: host, packages, services, accounts, credentials.
///
/// Pass to [`fusion_runtime::run_scan_at`] or [`fusion_runtime::run_scan_at_with`].
