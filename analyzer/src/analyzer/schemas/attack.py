...
ontology) and bundled playbook templates. analyzer ingests it as OPAQUE JSON and never
imports or hard-codes the producing tool — it only consumes this contract.

`AttackPath` is analyzer's own output: a posture-grounded chain of techniques that an
